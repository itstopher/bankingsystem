    ...
    <div class="collapse navbar-collapse" id="homePane">
        <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item active">
                <a class="nav-link" id="smoney" href="checkaccounts.jsp">Check Accounts<span class="sr-only">(current)</span></a>
            </li>
            <li class="nav-item">
                <a class="nav-link" id="viewTrans" href="sendmoney.jsp">Send Money</a>
            </li>
            <li class="nav-item">
